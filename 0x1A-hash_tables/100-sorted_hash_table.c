 ...
 *
 * Return: if an error occurs it will return  NULL.
 *         Otherwise it will return  a pointer to the new sorted hash table.
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
 ...
 * @key:thsi is  the key to add - cannot be an empty string.
 ...
 *return: if the key cannot be matched it will return  NULL.
